    ...
    <div>
      ...
      <div className="about-me">
        ...
        <div className="about-me__content">
          ...
          <p className="about-me__description font_items">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus placerat rutrum. Aenean eget ultrices lacus. Curabitur ut ligula mi. Nulla ut risus lorem. Nam hendrerit eleifend libero, non iaculis sapien semper nec.</p>
          <div>
